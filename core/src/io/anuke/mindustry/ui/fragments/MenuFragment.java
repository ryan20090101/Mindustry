...
public class MenuFragment extends Fragment{
    ...
    public void build(Group parent){
        ...
        String versionText = "[#ffffffba]" + ((Version.build == -1) ? "[#fc8140aa]custom build" : (Version.type.equals("official") ? Version.modifier : Version.type) + " build " + Version.build + (Version.revision == 0 ? "" : "." + Version.revision) + (Version.commit != null ? " commit " + Version.commit : ""));
