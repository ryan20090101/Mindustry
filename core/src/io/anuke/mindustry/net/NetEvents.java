...
public class NetEvents {
    ...
    public static void handleBlockConfig(Tile tile, int intData, byte... byteData){
        BlockConfigPacket packet = new BlockConfigPacket();
        packet.intData = intData;
    ...
    public static void handleSendMessage(String message){
        ...
        if(Net.server() && !headless){
            ui.chatfrag.addMessage(message, netCommon.colorizeName(player.id, player.dimension, player.name));
        }
    }
