...
public class ToggleConveyor extends LogicBlock {
	...
	protected ToggleConveyor(String name) {
		super(name);
		rotate = true;
		update = true;
		layer = Layer.overlay;
	...
	public boolean canReplace(Block other){
		return other instanceof Conveyor || other instanceof Router || other instanceof Junction || other instanceof ToggleConveyor;
	}
	...
	private static void sort(long[] elements, int length){
		...
		Collections.sort(wrapper, ToggleConveyor::compareItems);
	}
