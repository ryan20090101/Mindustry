...
public class Recipes {
	private static final Array<Recipe> list = Array.with(
			...
			new Recipe(distribution, DistributionBlocks.coreIn, stack(Item.stone, 2)),
			...
			new Recipe(production, ProductionBlocks.grounddrill, stack(Item.stone, 12)),
			...
			new Recipe(production, ProductionBlocks.sieve, stack(Item.steel, 12)),
