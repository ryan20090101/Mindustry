...
public abstract class BaseBulletAltDimType<T extends BulletAltDimEntity>{
    private static int lastid = 0;
    private static Array<BaseBulletAltDimType> types = new Array<>();
    ...
    public static BaseBulletAltDimType<?> getByID(int id){
        return types.get(id);
    }
}
